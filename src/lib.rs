...
#[derive(Debug)]
pub struct RenderCloudProcessor {
    verbose: bool,
    processed_count: usize,
}

impl RenderCloudProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting RenderCloud processing");
    
    let mut processor = RenderCloudProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = RenderCloudProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = RenderCloudProcessor::new(false);
